...
for i in {00..14}
  do
    ...
    CUDA_VISIBLE_DEVICES=`expr $i % 4` python main_test_face_swinir.py -i /public/caixin/GazeData/MPIIFaceGaze/Image/p$i/face -o /public/caixin/GazeData/MPIIRes/$1/Image/p$i/face --iter $2 --sothis 0  &
